...
| 4 | [agenticnotetaking/arscontexta](https://github.com/agenticnotetaking/arscontexta) | Shell | Claude Code plugin that generates individualized knowledge systems from conversation. You describe h |
| 5 | [agentscope-ai/ReMe](https://github.com/agentscope-ai/ReMe) | Python | ReMe: Memory Management Kit for Agents - Remember Me, Refine Me. |
| 6 | [AgriciDaniel/claude-obsidian](https://github.com/AgriciDaniel/claude-obsidian) | Python | Self-organizing AI second brain for Obsidian + Claude Code. Drop any source and Claude reads, links, |
| 7 | [alvinreal/awesome-opensource-ai](https://github.com/alvinreal/awesome-opensource-ai) | Python | Curated list of the best truly open-source AI projects, models, tools, and infrastructure. Daily upd |
...
| 22 | [duckdb/duckdb](https://github.com/duckdb/duckdb) | C++ | DuckDB is an analytical in-process SQL database management system |
...
| 31 | [harvard-edge/cs249r_book](https://github.com/harvard-edge/cs249r_book) | Python | Machine Learning Systems: Foundations, Scaling, Agentic AI, and Physical AI (Vols I–IV) • Harvard CS |
...
| 50 | [mem0ai/mem0](https://github.com/mem0ai/mem0) | Python | The Memory Layer for AI Agents - Drop-in memory infrastructure for AI agents and apps. Context that  |
...
| 63 | [NVIDIA-AI-Blueprints/video-search-and-summarization](https://github.com/NVIDIA-AI-Blueprints/video-search-and-summarization) | Python | NVIDIA AI Blueprint for video search and summarization (VSS) is a GPU-accelerated reference architec |
...
| 89 | [thedotmack/claude-mem](https://github.com/thedotmack/claude-mem) | TypeScript | Persistent Context Across Sessions for Every Agent –  Captures everything your agent does during ses |
...
| 93 | [unclecode/crawl4ai](https://github.com/unclecode/crawl4ai) | Python | Open-source web crawler and scraper for LLMs and AI agents: any website into clean, LLM-ready Markdo |
