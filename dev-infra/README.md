...
| 10 | [deepseek-ai/DeepEP](https://github.com/deepseek-ai/DeepEP) | Cuda | DeepEP: an efficient expert-parallel communication library |
| 11 | [docusealco/docuseal](https://github.com/docusealco/docuseal) | Ruby | Open source DocuSign alternative. Create, fill, and sign digital documents ✍️ |
| 12 | [fastfetch-cli/fastfetch](https://github.com/fastfetch-cli/fastfetch) | C | A maintained, feature-rich and performance oriented, neofetch like system information tool. |
| 13 | [flutter/skills](https://github.com/flutter/skills) | Dart | — |
| 14 | [gnekt/My-Brain-Is-Full-Crew](https://github.com/gnekt/My-Brain-Is-Full-Crew) | Shell | Built by a PhD whose memory was failing, whose diet was a mess, and whose anxiety had its own agenda |
| 15 | [gohugoio/hugo](https://github.com/gohugoio/hugo) | Go | The world’s fastest framework for building websites. |
| 16 | [hesamsheikh/awesome-openclaw-usecases](https://github.com/hesamsheikh/awesome-openclaw-usecases) | — | A community collection of OpenClaw use cases for making life easier. |
| 17 | [hiyouga/LLMs-From-Pretrain-To-Agents](https://github.com/hiyouga/LLMs-From-Pretrain-To-Agents) | TeX | — |
| 18 | [ieshreya/sql-50-leetcode](https://github.com/ieshreya/sql-50-leetcode) | — | Solutions for SQL 50 Study Plan on LeetCode |
| 19 | [iuliaturc/gguf-docs](https://github.com/iuliaturc/gguf-docs) | — | Docs for GGUF quantization (unofficial) |
...
| 33 | [saidrassai/saidrassai.github.io](https://github.com/saidrassai/saidrassai.github.io) | CSS | — |
| 34 | [saidrassai/sql-50-leetcode](https://github.com/saidrassai/sql-50-leetcode) | — | Solutions for SQL 50 Study Plan on LeetCode |
| 35 | [sepinf-inc/IPED](https://github.com/sepinf-inc/IPED) | Java | IPED Digital Forensic Tool. It is an open source software that can be used to process and analyze di |
| 36 | [shadps4-emu/shadPS4](https://github.com/shadps4-emu/shadPS4) | C++ | PlayStation 4 emulator for Windows, Linux, macOS and FreeBSD written in C++ |
| 37 | [sindresorhus/awesome](https://github.com/sindresorhus/awesome) | — | 😎 Awesome lists about all kinds of interesting topics |
| 38 | [sipeed/picoclaw](https://github.com/sipeed/picoclaw) | Go | Tiny, Fast, and Deployable anywhere — automate the mundane, unleash your creativity |
| 39 | [telegramdesktop/tdesktop](https://github.com/telegramdesktop/tdesktop) | C++ | Telegram Desktop messaging app |
| 40 | [ThomasVrancken/info9023-mlops](https://github.com/ThomasVrancken/info9023-mlops) | — | Repo centralising material for the ULiege course INFO9023 "Machine Learning Systems Design (MLOps)". |
| 41 | [torvalds/linux](https://github.com/torvalds/linux) | C | Linux kernel source tree |
| 42 | [VFN-Research/AutoPaper](https://github.com/VFN-Research/AutoPaper) | — | Academic Research Editor |
